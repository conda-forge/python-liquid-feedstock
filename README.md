...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/python-liquid-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-liquid-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-liquid
# for installing globally
pixi global install python-liquid
```
...
It is possible to list all of the versions of `python-liquid` available on your platform:
...
```
pixi search python-liquid --channel conda-forge
```
